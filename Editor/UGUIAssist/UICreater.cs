...
namespace UGUIAssister
{
    ...
    internal class UICreater
    {
        ...
        {
            RectTransform parent = menuCommand.context as RectTransform;
            if (parent == null || parent.GetComponentInParent<Canvas>() == null)
            {
                parent = GetOrCreateCanvasGameObject().transform as RectTransform;
            }
            ...
            GameObjectUtility.SetParentAndAlign(element, parent.gameObject);
